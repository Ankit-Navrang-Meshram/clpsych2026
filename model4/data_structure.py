...
self_state_embedder = SelfStateEmbedder(model_path="./self_state_encoder.pt", device=device)
...
class Post:
    ...
    def from_dict(cls, d: Dict) -> "Post":
        ...
        self_state_embedding = self_state_embedder.embed(d.get("post", ""))
        post_embedding = np.concatenate([post_embedding, self_state_embedding])
